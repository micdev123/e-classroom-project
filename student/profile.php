...
<?php
    ...
    $query = "SELECT *, programName, facultyName, classCode FROM users INNER JOIN classroomstudents ON users._id = classroomstudents.student_id INNER JOIN classrooms ON classroomstudents.class_id = classrooms._id INNER JOIN programs ON classrooms.program = programs.programCode INNER JOIN faculties ON classrooms.faculty = faculties.facultyCode WHERE users._id = '$session_id' ";
                        ...
                        <div class="profile_left">
                            <div class="profile_head">
                                ...
                                <div class="user_content">
                                    ...
                                    <p><?php echo $profile['classCode']; ?></p>
                                </div>
                            </div>
                            <div class="info_container">
                                ...
                                <div class="info_content">
                                    <h4>Department:</h4>
                                    <p><p><?php echo $profile['programName']; ?></p></p>
                                </div>
                                <div class="info_content">
                                    <h4>Role:</h4>
                                ...
                                <div class="info_content">
                                    <h4>Semester:</h4>
                                    <p><p><?php echo $profile['semester']; ?></p></p>
                                </div>
                            </div>
                        </div>
